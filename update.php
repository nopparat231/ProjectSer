...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE employee SET name=%s, `position`=%s, salary=%s WHERE id=%s",
...
<table width="400" border="1" align="center">
    <tr>
      <th scope="col"><h2>แก้ไขข้อมูล</h2></th>
    </tr>
    <tr>
       ...
       <form id="form1" name="form1" method="post" action="">
        ...
        <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
          ...
          <table width="100%" align="center">
            <tr valign="baseline">
              <td align="right" nowrap="nowrap" bgcolor="#33FF99">รหัส</td>
              <td><?php echo $row_Recordset1['id']; ?></td>
            </tr>
            <tr valign="baseline">
              <td align="right" nowrap="nowrap" bgcolor="#33FF99">ชื่อ</td>
              <td><input type="text" name="name" value="<?php echo htmlentities($row_Recordset1['name'], ENT_COMPAT, ''); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right" nowrap="nowrap" bgcolor="#33FF99">ตำแหน่ง</td>
              <td>
            ...
            <tr valign="baseline">
              <td align="right" nowrap="nowrap" bgcolor="#33FF99">เงินเดือน</td>
